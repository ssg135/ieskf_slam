...
private:
    ...
    Keyframe buildLoopSubmapKeyframe(int target_keyframe_id) const;
    ...
    double dense_map_keyframe_voxel_leaf_size_;
    double dense_map_global_voxel_leaf_size_;
    double loop_submap_voxel_leaf_size_;
    double map_visualization_radius_;
    ...
    CeresPoseGraphOptimizer pose_graph_optimizer_;
